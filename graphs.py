...
def process_log():
	...
	data_l1 = LogFileData(path_file)
	window.withdraw()
	plot_pids_in_3d()
	# plot_3d_errors()
	# plot_errors()
	# plot_subfields()
	# data_l1.process_gps_data()
	del data_l1
	window.deiconify()
...
def plot_pids_in_3d():
	...
	data_l1.plot_error_in_3d(log_field = 'PIDR', folder_name = log_num)

	data_l1.plot_error_in_3d(log_field = 'PIDP', folder_name = log_num)

	data_l1.plot_error_in_3d(log_field = 'PIDY', folder_name = log_num)

	data_l1.plot_error_in_3d(log_field = 'PIDS', folder_name = log_num)
...
def plot_3d_errors():
	...
	data_l1.plot_error_in_3d(log_field = 'CTUN', var_calc = 'NavPitch',
		var_real = 'Pitch', label = 'Degrees (°)', folder_name = log_num)

	data_l1.plot_error_in_3d(log_field = 'CTUN', var_calc = 'NavRoll', 
		var_real = 'Roll', label= 'Degrees (°)', folder_name = log_num)
	
	data_l1.plot_error_in_3d(log_field = 'CTUN', var_calc = 'ThrDem', 
		var_real = 'ThrOut', label= 'Percentage (%)', folder_name = log_num)
	
	data_l1.plot_error_in_3d(log_field = 'NTUN', var_calc = 'NavBrg', 
...
def plot_errors():
	...
	data_l1.plot_error(log_field = 'CTUN', var_calc = 'NavPitch', 
		var_real = 'Pitch', ylabel= 'Degrees (°)', folder_name = log_num)

	data_l1.plot_error(log_field = 'CTUN', var_calc = 'NavRoll', 
		var_real = 'Roll', ylabel= 'Degrees (°)', folder_name = log_num)
	
	data_l1.plot_error(log_field = 'CTUN', var_calc = 'ThrDem', 
		var_real = 'ThrOut', ylabel= 'Percentage (%)', folder_name = log_num)
	
	data_l1.plot_error(log_field = 'NTUN', var_calc = 'NavBrg', 
...
def plot_subfields(file_name = 'default'):
	...
	data_l1.plot_data(log_field = 'CTUN', sub_fields=['RdrOut'], 
						ylabel = 'Centi-degrees (°)', title = 'Rudder Out',
						folder_name = log_num)

	data_l1.plot_data(log_field = 'NTUN', sub_fields = ['WpDist'], 
						ylabel = 'Distance (m)', title = 'Waypoint Distance',
						folder_name = log_num)

	data_l1.plot_data(log_field = 'NTUN', sub_fields = ['AltErr'], 
						ylabel = 'Height (m)', title = 'Height Error',
						folder_name = log_num)

	data_l1.plot_data(log_field = 'NTUN', sub_fields = ['XT'], 
						ylabel = 'Distance (m)', title = 'Distance from Travel Segment',
						folder_name = log_num)

	data_l1.plot_data(log_field = 'NTUN', sub_fields = ['ArspdErr'], 
